                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white mt-1">{product.name} {product.image_path}</h1>
                            ...
                            <div className="flex gap-4 pt-6">
                                ...
                                <button className="flex-1 px-8 py-3 bg-gray-800 hover:bg-gray-700 border border-gray-700 text-white font-medium rounded-lg">
                                    Save
                                </button>
                            </div>
                        </div>
